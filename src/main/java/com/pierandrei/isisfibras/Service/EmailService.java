    ...
    public void sendEmail(String title, String name, String content, String linkImageOffer, String principalLink, String emailTo) {
        try {
            ...
            String htmlContent = "<html lang='pt-BR'>"
                    ...
                    + "                            <h1 style='color: #007bff; font-size: 1.5em;'>" + title + " </h1>"
                    + "                            <p style='color: #333; font-size: 1.2em;'>Prezado(a) <strong>" + name + "</strong>, fique por"
                    + "                                dentro das <strong>promoções!</strong></p>"
